<?php
// L'instruction require_once est identique à require mis à part que PHP vérifie si le fichier a déjà été inclus, et si c'est le cas, ne l'inclue pas une deuxième fois.

require_once 'Vehicule.php';

// Instanciation de 2 nouveaux objets.
